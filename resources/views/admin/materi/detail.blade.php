...
<div class="container-fluid py-3">
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-3 mb-4">
        <div>
            <h3 class="fw-bold text-slate-800 mb-1">Detail Materi</h3>
            <p class="text-secondary mb-0">Lihat data dan isi materi pembelajaran</p>
        </div>
        <div class="d-flex gap-2">
            <a href="/admin/materi/{{ $materi->id }}/edit" class="btn btn-outline-warning px-3 py-2 rounded-3 d-inline-flex align-items-center gap-1.5 fw-medium">
                <i class="bi bi-pencil"></i> Edit
            </a>
            <a href="/admin/materi" class="btn btn-outline-secondary px-3 py-2 rounded-3 d-inline-flex align-items-center gap-1.5 fw-medium">
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm overflow-hidden mb-4">
                <div class="card-header bg-white py-3 px-4">
                    <h5 class="fw-semibold text-slate-800 mb-0">Pratinjau Konten</h5>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    <h5 class="fw-semibold text-slate-800 mb-3">Informasi Materi</h5>
                    ...
                    <div class="d-flex align-items-center justify-content-between p-2.5 bg-light rounded-3 border" style="border-color: rgba(226, 232, 240, 0.8) !important;">
                        <span class="text-secondary small fw-medium">Tanggal Dibuat</span>
                        <span class="text-dark small fw-semibold">
                            <i class="bi bi-calendar3 text-secondary me-1.5"></i>{{ $materi->created_at->format('d M Y, H:i') }}
                        </span>
                    </div>
                </div>
            </div>
